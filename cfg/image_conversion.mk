...
PALETTE=0 8 13 3 6 15 24 18 9 12 20 11 2 4 1 26

$(eval $(call IMG2SP, SET_MODE        , 0                  ))
$(eval $(call IMG2SP, SET_FOLDER      , src/palette               ))
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
...
$(eval $(call IMG2SP, CONVERT         , assets/sprites/dots.png , 12, 12, sp_dots, , ))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/dice.png , 14, 15, sp_dice, , ))

$(eval $(call IMG2SP, SET_FOLDER      , src/comp               ))
$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen            ))
$(eval $(call IMG2SP, SET_OUTPUT      , bin                  ))
$(eval $(call IMG2SP, CONVERT         , assets/screen/optimus.png , 164, 200, bg_optimus, , ))
#$(eval $(call IMG2SP, CONVERT         , assets/screen/screen_dump.png , 164, 200, bg_sd, , ))
